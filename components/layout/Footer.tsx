...
export function Footer() {
  return <footer className="bg-[#0B1424] text-slate-300">
    <div className="container-page grid gap-10 py-14 sm:grid-cols-2 lg:grid-cols-[1.2fr_repeat(3,1fr)]">
      <div><a href="/"><Image src="/images/logo/trolinktek-logo-light.svg" width={170} height={40} alt="TrolinkTek home" /></a><p className="mt-5 max-w-xs text-sm leading-6">CarPlay product supply and flexible OEM/ODM support for global B2B partners.</p><p className="mt-5 text-sm"><a href="mailto:support@trolink.cn">support@trolink.cn</a><br /><a className="mt-2 inline-block" href="https://wa.me/8618576474087">WhatsApp: +86 18576474087</a></p></div>
